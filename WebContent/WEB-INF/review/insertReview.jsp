...
<div class="container" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<div class="field" style="text-align:center;">
		<h2 class="title is-1 is-spaced"><strong>리뷰쓰기</strong></h2>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input class="input" type="text" name="rtitle" id="rtitle" maxlength="98" title="100자 내로 작성" placeholder="100자 내로 작성" class="form-control" required autofocus>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="file" name="file1" id="file1" class="file-label">
						</td>
					</tr>
					<tr>
						<td colspan="2">
