			...
			<table class="table is-fullwidth">
				<tbody>
					...
					<tr>
						...
						<td>
							<span>${user.pw }</span>
							<input class="input" type="password" name="ppw" id="ppw" placeholder="비밀번호 입력" class="form-control" maxlength="15" value="" required />
							<input class="input" type="hidden" name="pw" id="pw" value="${user.pw }" />
							<input class="input" type="hidden" name="hpw" id="hpw" value="${user.hpw }" />
							<p>비밀번호는 최소 8자리에서 최대 16자리까지 숫자, 영문, 특수문자 각 1개 이상 포함되어야 함</p>
						</td>
					</tr>
					<tr>
						<th>비밀번호 확인</th>
						<td><input class="input" type="password" name="ppw2" id="ppw2" placeholder="비밀번호  확인 입력" class="form-control" value="" maxlength="15" /></td>
					...
					<tr>
						...
						<td>
							...
							<input class="input" type="hidden" name="addr" id="addr" value="${user.addr }" />
							<input class="input" type="text" name="address1" id="address1" placeholder="기본 주소 입력" class="form-control" /><br>
							<input class="input" type="text" name="address2" id="address2" placeholder="상세 주소 입력" class="form-control" /><br>
					...
					<tr>
						<td colspan="2">
							...
							<a href="${path1 }/MyPage.do" class="button is-light">마이페이지로 이동</a>
						</td>
					</tr>
				</tbody>
			</table>
