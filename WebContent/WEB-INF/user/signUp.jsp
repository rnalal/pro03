...
<div class="container" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<section class="filed">
		<h2 class="title is-1 is-spaced">회원가입</h2>
			...
			<table class="table is-fullwidth">
				<tbody>
					<tr>
						...
						<td>
							<div class="form-row">
								...
								<input class="input" type="button" class="button" value="아이디 중복 확인" onclick="idCheck()">
								<input class="input" type="hidden" name="idck" id="idck" value="no">
							</div>
							<div>
								<c:if test="${empty qid }">
					...
					<tr>
						<th>비밀번호</th>
						<td>
							<input class="input" type="password" name="pw" id="pw" placeholder="비밀번호 입력" class="form-control" pattern="^{8,16}$" maxlength="16" required />
						</td>
					</tr>
					<tr>
						<th>비밀번호 확인</th>
						<td><input class="input" type="password" name="pw2" id="pw2" placeholder="비밀번호  확인 입력" class="form-control" pattern="^{8,16}$" maxlength="16" required /></td>
					</tr>
					<tr>
						<th>회원이름</th>
					...
					<tr>
						<td colspan="2">
							<input type="submit" value="회원가입" class="button is-light"/>
