...
<div class="container" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<section class="filed">
		<h2 class="title is-1 is-spaced">${user.name }님의 정보</h2>
		<table class="table is-fullwidth">
			<tbody>
				...
				<tr>
					<td colspan="2">
						<a href="${path1 }/UpdateUser.do?id=${user.id}" class="button is-light">회원 정보 수정</a>
						<a href="${path1 }/DeleteUser.do?id=${user.id}" class="button is-light">회원 탈퇴</a>
